...
def windows_group_policy_path(profile="Default"):
...
class Chrome(ChromiumBased):
    def __init__(self, cookie_file=None, domain_name="", key_file=None, profile="Default"):
        args = {
            ...
            'windows_cookies':[
                    {'env':'APPDATA', 'path':'..\\Local\\Google\\Chrome\\User Data\\' + profile + '\\Cookies'},
                    {'env':'LOCALAPPDATA', 'path':'Google\\Chrome\\User Data\\' + profile + '\\Cookies'},
                    {'env':'APPDATA', 'path':'Google\\Chrome\\User Data\\' + profile + '\\Cookies'}
                ],
            'osx_cookies': ['~/Library/Application Support/Google/Chrome/' + profile + '/Cookies'],
            'windows_keys': [
...
class Chromium(ChromiumBased):
    def __init__(self, cookie_file=None, domain_name="", key_file=None, profile="Default"):
        args = {
            'linux_cookies':['~/.config/chromium/profile/Cookies'],
            'windows_cookies':[
                    {'env':'APPDATA', 'path':'..\\Local\\Chromium\\User Data\\' + profile + '\\Cookies'},
                    {'env':'LOCALAPPDATA', 'path':'Chromium\\User Data\\' + profile + '\\Cookies'},
                    {'env':'APPDATA', 'path':'Chromium\\User Data\\' + profile + '\\Cookies'}
            ],
            'osx_cookies': ['~/Library/Application Support/Chromium/' + profile + '/Cookies'],
            'windows_keys': [
...
class Edge(ChromiumBased):
    def __init__(self, cookie_file=None, domain_name="", key_file=None, profile="Default"):
        args = {
            ...
            'windows_cookies':[
                    {'env':'APPDATA', 'path':'..\\Local\\Microsoft\\Edge\\User Data\\' + profile + '\\Cookies'},
                    {'env':'LOCALAPPDATA', 'path':'Microsoft\\Edge\\User Data\\' + profile + '\\Cookies'},
                    {'env':'APPDATA', 'path':'Microsoft\\Edge\\User Data\\' + profile + '\\Cookies'}
            ],
            'osx_cookies': ['~/Library/Application Support/Microsoft Edge/' + profile + '/Cookies'],
            'windows_keys': [
...
def chromium(cookie_file=None, domain_name="", key_file=None, profile="Default"):
    """Returns a cookiejar of the cookies used by Chromium. Optionally pass in a
    domain name to only load cookies from the specified domain
    """
    return Chromium(cookie_file, domain_name, key_file, profile).load()
...
def edge(cookie_file=None, domain_name="", key_file=None, profile="Default"):
    """Returns a cookiejar of the cookies used by Microsoft Egde. Optionally pass in a
    domain name to only load cookies from the specified domain
    """
    return Edge(cookie_file, domain_name, key_file, profile).load()
